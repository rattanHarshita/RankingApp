...
namespace RankingApp.Controllers
{
    ...
    {
        private readonly static IEnumerable<ItemModel> Items = new[]
        {
             ...
             new ItemModel{Id =4, Title = "Last of Mohicans", ImageId=4, Ranking=0,ItemType=1 },
             new ItemModel{Id =5, Title = "Police Academy", ImageId=5, Ranking=0,ItemType=1 },
             ...
             new ItemModel{Id =8, Title = "Shawshank Redemption", ImageId=8, Ranking=0,ItemType=1 },
             new ItemModel{Id =9, Title = "Star Treck", ImageId=9, Ranking=0,ItemType=1 },
             new ItemModel{Id =10, Title = "Superman", ImageId=10, Ranking=0,ItemType=1 },
